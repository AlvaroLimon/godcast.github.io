...
import { new_hombre_celular_movil, new_hombre_sala_movil, new_mujer_celular_movil, new_mujer_cocina_movil, new_hombre_padel_movil, new_mujer_coche_movil } from '../assets/images/people/assets_people'
  ...
  return (
    <div className='carouselmobile2' style={isActive ? {transform: `translateX(${position}%)`} : {transform: `translateX(0)`}}>
        <div className='carouselmobile2_images_container'>
            ...
            <div className='carouselmobile2_image'>
                <img className='carouselmobile2_img' src={new_mujer_coche_movil} alt='audifonos' />
            </div>
            <div className='carouselmobile2_image'>
                <img className='carouselmobile2_img' src={new_hombre_padel_movil} alt='audifonos' />
            </div>
        </div>
    </div>
  )
